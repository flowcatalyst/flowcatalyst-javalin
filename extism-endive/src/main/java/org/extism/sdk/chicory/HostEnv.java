...
public class HostEnv {
    ...
    public class Memory {
        ...
        public run.endive.runtime.Memory memory() {
    ...
    public class Http {
        ...
        public long[] headers() {
            ...
            // FlowCatalyst change (see NOTICE): upstream encoded Map.of() here, so the
            // guest never saw a response header even with headers enabled.
