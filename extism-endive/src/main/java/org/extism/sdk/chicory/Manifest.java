...
public class Manifest {
    ...
    public static class Options {
        ...
        /// FlowCatalyst change (see NOTICE): the Extism kernel's own memory cap, in pages.
        public Options withKernelMemoryMaxPages(int maxPages) {
            this.kernelMaxPages = maxPages;
            return this;
        }
