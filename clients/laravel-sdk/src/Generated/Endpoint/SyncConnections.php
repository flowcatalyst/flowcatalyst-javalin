...
class SyncConnections extends \FlowCatalyst\Generated\Runtime\Client\BaseEndpoint implements \FlowCatalyst\Generated\Runtime\Client\Endpoint
{
    protected $appCode;
    /**
     ...
     * } $queryParameters
     */
    public function __construct(string $appCode, ?\FlowCatalyst\Generated\Model\SyncConnectionsRequest $requestBody = null, array $queryParameters = [])
    {
    ...
    {
        return str_replace(['{appCode}'], [$this->appCode], '/api/applications/{appCode}/connections/sync');
    }
    public function getBody(\Symfony\Component\Serializer\SerializerInterface $serializer, $streamFactory = null): array
    {
        if ($this->body instanceof \FlowCatalyst\Generated\Model\SyncConnectionsRequest) {
