...
# jdk.naming.dns (JndiTxtResolver's com.sun.jndi.dns.DnsContextFactory) is gone:
# function-domains-no-dns.md removed the DNS TXT verification path entirely, so
