...
///
/// [io.flowcatalyst.http.Exchange#json] and [io.flowcatalyst.http.Exchange#bodyAsClass]
/// write and read through this mapper directly (`io.flowcatalyst.http.vertx.VertxExchange`).
