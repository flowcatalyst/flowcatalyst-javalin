...
public final class SetDeveloperCredential {
    ...
    public static Operation<SetDeveloperCredentialCommand, DeveloperCredentialSet> of(PrincipalRepository repo, DeveloperSecrets secrets) {
        return Operation.<SetDeveloperCredentialCommand, DeveloperCredentialSet>named("SetDeveloperCredential")
                ...
                .execute((cmd, ec) -> {
                    ...
                    p = p.withDeveloperSecret(secrets.issueFor(p.id()).encryptedRef());
