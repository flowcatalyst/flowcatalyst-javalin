...
/// mapped, claimed from another provider, released back to the internal
/// provider, and how many OIDC-provisioned users those releases converted
/// back to internal auth.
public record UpdateResult(String identityProviderId, String code, List<String> domainsCreated,
                           List<String> domainsClaimed, List<String> domainsReleased, int usersReset) {
    public UpdateResult {
