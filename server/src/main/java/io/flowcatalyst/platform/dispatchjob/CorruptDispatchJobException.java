...
/// per-row mapper.
public final class CorruptDispatchJobException extends RuntimeException {

    private final String dispatchJobId;

    public CorruptDispatchJobException(String dispatchJobId, Throwable cause) {
        super("dispatch job " + dispatchJobId + " has a corrupt status: " + cause.getMessage(), cause);
