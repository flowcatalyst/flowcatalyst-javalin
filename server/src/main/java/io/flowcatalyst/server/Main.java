...
public final class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Optional<Frontend> fallback = env.platformEnabled() ? Frontend.embedded() : Optional.empty();
        fallback.ifPresent(_ -> LOG.info("embedded Vue SPA available"));

        var running = new Server(env, pool, fallback, PrometheusRegistry.defaultRegistry).start();
