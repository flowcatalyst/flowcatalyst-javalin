import{f as p,o,g as a,h as f,m as s,Y as u,a1 as m,af as h}from"./index-BIqiCuGY.js";var y={name:"BlankIcon",extends:p};function $(n){return b(n)||v(n)||C(n)||g()}function g(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
