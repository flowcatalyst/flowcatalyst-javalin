import{f as p,o,g as a,h as f,m as s,$ as u,a3 as m,ah as h}from"./index-DWQmJSho.js";var y={name:"BlankIcon",extends:p};function $(n){return b(n)||v(n)||C(n)||g()}function g(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
