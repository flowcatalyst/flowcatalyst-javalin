import{f as p,o,g as a,h as f,m as s,X as u,a0 as m,ae as h}from"./index-fpAKIggb.js";var y={name:"BlankIcon",extends:p};function $(n){return b(n)||v(n)||C(n)||g()}function g(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
