...
/// A minimal software authenticator for the tests: one ES256 key, a random
/// credential id, a signature counter, "none" attestation. It answers a
/// `navigator.credentials.create()` / `.get()` the way a platform
